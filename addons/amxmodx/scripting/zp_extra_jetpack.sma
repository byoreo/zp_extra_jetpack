...
#define PLUGINNAME		"[ZP] Extra Item: Jetpack"
#define VERSION			"1.0"
...
#define JETPACK_COST 70 // set how may ammopacks the Jatpack+Rocket cost

new ROCKET_MDL[64] = "models/jetpack/rpgrocket.mdl"
new ROCKET_SOUND[64] = "jetpack/rocketfire.wav"
new getrocket[64] = "jetpack/ready.wav"
...
public plugin_init() {
	...
	g_item_jetpack = zp_register_extra_item("Jetpack", JETPACK_COST, ZP_TEAM_HUMAN)
...
public plugin_precache() {
	precache_model("models/jetpack/p_jetpack.mdl")
	precache_model("models/jetpack/v_jetpack.mdl")
	precache_model("models/jetpack/w_jetpack.mdl")
	precache_sound("jetpack/jetpack.wav")
	precache_sound("jetpack/jp_blow.wav")
...
public switchmodel(id) {
	entity_set_string(id,EV_SZ_viewmodel,"models/jetpack/v_jetpack.mdl")
	entity_set_string(id,EV_SZ_weaponmodel,"models/jetpack/p_jetpack.mdl")
}
...
public drop_jetpack(player) {
	if(hasjet[player]) {
		...
		entity_set_model(jetpack,"models/jetpack/w_jetpack.mdl")	
